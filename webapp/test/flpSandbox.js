		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#palindrome1palindromeproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"palindrome1palindromeproject1-display": {
								"semanticObject": "palindrome1palindromeproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=palindrome1.palindromeproject1",
									"url": sap.ui.require.toUrl("palindrome1/palindromeproject1")
								}
							}
						}
					}
